...
$academic_affiliation       = trim((string)($_POST['academic_affiliation']       ?? ''));
...
$accountType                = trim((string)($_POST['account_type']               ?? 'listing'));
...
// Check if academic_affiliation column exists
...
$academicAffiliationCol = $hasAcademicAffiliation ? ', academic_affiliation' : '';
$academicAffiliationVal = $hasAcademicAffiliation ? ', :academic_affiliation' : '';
...
$stmt = $pdo->prepare("
    ...
    (doctor_id, name, title, academic_title, medical_school_affiliation,
     ...
     password_hash, account_type, profile_visibility,
     bio, education, experience, gender, languages, awards,
     accepting_patients, profile_image, status{$academicAffiliationCol})
    VALUES
    (:doctor_id, :name, :title, :academic_title, :medical_school_affiliation,
     :specialty, :subspecialty, :graduation_degree, :graduation_year,
     :location, :practice, :address, :hospital_affiliations, :phone, :email,
     :password_hash, :account_type, :profile_visibility,
     :bio, :education, :experience, :gender, :languages, :awards,
     :accepting_patients, :profile_image, :status{$academicAffiliationVal})
");
